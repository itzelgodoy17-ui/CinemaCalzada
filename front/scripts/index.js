...
// if(location.hostname.includes("AñadirPeliculas.html")){
//   createFormFunc()
// }
...
$(document).ready(function() {
  ...
  // Solo llamamos a obtenerPeliculas si estamos en la página de películas
...
// Verificamos si estamos en la página de añadir películas usando pathname
if (location.pathname.includes("AñadirPeliculas.html")) {
  // Asegúrate de que createFormFunc esté disponible
  if (typeof createFormFunc === 'function') {
    createFormFunc();
  }
}